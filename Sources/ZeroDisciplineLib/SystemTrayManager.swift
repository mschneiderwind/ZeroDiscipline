...
public class SystemTrayManager {
    ...
    private func setupSystemTray() {
        ...
        if let button = statusItem.button {
            button.image = NSImage(
                systemSymbolName: "target", accessibilityDescription: "Zero Discipline")
    ...
    private func setupMenuItems() {
        ...
        let configItem = NSMenuItem(
            title: "Configuration...", action: #selector(showConfiguration), keyEquivalent: ",")
        ...
        let quitItem = NSMenuItem(
            title: "Quit Zero Discipline", action: #selector(quitApplication), keyEquivalent: "q")
